        ...
        <article>
          ...
          <div className="count">
            <h4
              ...
              Total Students: 0{<CountingAnimation value={TotalStudents} />}{" "}
            </h4>
            <h4
              className="nowrap overflow"
              style={{ margin: "0", padding: "0" }}>
              Total Staff: 0{<CountingAnimation value={TotalStaff} />}{" "}
            </h4>
          </div>
        </article>
        <article>
          ...
          <div className="count">
            <h4
              className="nowrap overflow"
              style={{ margin: "0", padding: "0" }}>
              Total Rooms: 0{<CountingAnimation value={TotalRooms} />}{" "}
            </h4>
            <h4
              className="nowrap overflow"
              style={{ margin: "0", padding: "0" }}>
              Total Payments: 0{<CountingAnimation value={TotalRoomsActive} />}{" "}
            </h4>
            <h4
              className="nowrap overflow"
              style={{ margin: "0", padding: "0" }}>
              Booked Rooms: 0{<CountingAnimation value={TotalStudentsBooked} />}{" "}
            </h4>
          </div>
        </article>
      </div>
