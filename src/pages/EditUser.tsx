			...
			<article >
				...
				<form >
					...
					<div >
						...
						<input type="number" value={floor} required onChange={(e) => setFloor(e.target.value)} />

						<label>Room number</label>
						<input type="number" value={room} required onChange={(e) => setRoom(e.target.value)} />
					</div>

					<fieldset>
						<legend>Booking</legend>
						<input type="radio" id="radio-1" name="radio" checked={booking} onChange={() => setBooking(true)} value="radio-1" />
						<label htmlFor="radio-1">Yes</label>
						<input type="radio" id="radio-2" name="radio" checked={!booking} onChange={() => setBooking(false)} value="radio-2" />
