		...
		>
			...
			<form >
				<article>
					...
					<input type="text" value={userName} placeholder={User?.student_name} onChange={(e) => setUserName(e.target.value)} />
					<label >Adress</label>
					...
					<input type="text" value={gurdian_name} placeholder={User?.gurdian_name} onChange={(e) => setGurdian_name(e.target.value)} />
					<label>Gender</label>
					<input type="text" value={gender} placeholder={User?.gender} onChange={(e) => setGender(e.target.value)} />
					<label>Emergency Number</label>
					<input type="text" value={emergency_number} placeholder={User?.emergency_number} onChange={(e) => setEmergency_number(e.target.value)} />
					<label>Religion</label>
					<input type="text" value={religion} placeholder={User?.religion} onChange={(e) => setReligion(e.target.value)} />
					<label>Nationality</label>
					<input type="text" value={Nationality} placeholder={User?.nationality} onChange={(e) => setNationality(e.target.value)} />
					<footer>
